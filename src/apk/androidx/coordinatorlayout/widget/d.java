...
public class d {
    ...
    private static final ThreadLocal<Matrix> f1240a = new ThreadLocal<>();

    /* renamed from: b reason: collision with root package name */
    private static final ThreadLocal<RectF> f1241b = new ThreadLocal<>();
    ...
    static void b(ViewGroup viewGroup, View view, Rect rect) {
        Matrix matrix = (Matrix) f1240a.get();
        if (matrix == null) {
            matrix = new Matrix();
            f1240a.set(matrix);
        } else {
