...
import androidx.appcompat.widget.C0169i;
import androidx.appcompat.widget.C0171k;
import androidx.appcompat.widget.C0172l;
import androidx.appcompat.widget.C0173m;
import androidx.appcompat.widget.C0176p;
import androidx.appcompat.widget.C0179t;
import androidx.appcompat.widget.C0182w;
import androidx.appcompat.widget.C0183x;
...
public class AppCompatViewInflater {
    ...
    private static class a implements OnClickListener {
        ...
        private void a(Context context, String str) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted()) {
                        Method method = context.getClass().getMethod(this.f409b, new Class[]{View.class});
                        if (method != null) {
                            this.f410c = method;
                            this.f411d = context;
                            return;
            ...
            int id = this.f408a.getId();
            if (id == -1) {
                str2 = "";
            } else {
                StringBuilder sb = new StringBuilder();
                sb.append(" with id '");
                sb.append(this.f408a.getContext().getResources().getResourceEntryName(id));
                sb.append("'");
                str2 = sb.toString();
            }
            ...
            sb2.append(this.f408a.getClass());
            sb2.append(str2);
        ...
        public void onClick(View view) {
            if (this.f410c == null) {
                a(this.f408a.getContext(), this.f409b);
            }
            try {
                this.f410c.invoke(this.f411d, new Object[]{view});
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT < 15 || B.x(view)) {
    ...
    public C0169i createAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        return new C0169i(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public C0171k createButton(Context context, AttributeSet attributeSet) {
        return new C0171k(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public C0172l createCheckBox(Context context, AttributeSet attributeSet) {
        return new C0172l(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public C0173m createCheckedTextView(Context context, AttributeSet attributeSet) {
        return new C0173m(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public C0176p createEditText(Context context, AttributeSet attributeSet) {
        return new C0176p(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public r createImageButton(Context context, AttributeSet attributeSet) {
    ...
    /* access modifiers changed from: protected */
    public C0179t createMultiAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        return new C0179t(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public C0182w createRadioButton(Context context, AttributeSet attributeSet) {
        return new C0182w(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public C0183x createRatingBar(Context context, AttributeSet attributeSet) {
        return new C0183x(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public C0184y createSeekBar(Context context, AttributeSet attributeSet) {
        return new C0184y(context, attributeSet);
    }

    /* access modifiers changed from: protected */
    public androidx.appcompat.widget.B createSpinner(Context context, AttributeSet attributeSet) {
