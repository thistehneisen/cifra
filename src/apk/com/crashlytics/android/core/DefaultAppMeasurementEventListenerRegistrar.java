...
class DefaultAppMeasurementEventListenerRegistrar implements AppMeasurementEventListenerRegistrar {
    ...
    public static void writeEventToUserLog(CrashlyticsCore crashlyticsCore2, String str, Bundle bundle) {
        try {
            ...
            sb2.append(str);
            e2.a(CrashlyticsCore.TAG, sb2.toString());
        }
    }
        ...
        if (this.eventListenerProxy == null) {
            this.eventListenerProxy = Proxy.newProxyInstance(this.crashlyticsCore.getContext().getClassLoader(), new Class[]{cls}, new InvocationHandler() {
                ...
                public Object invoke(Object obj, Method method, Object[] objArr) {
                    ...
                    f.e().b(CrashlyticsCore.TAG, sb2.toString());
                    return null;
                }
            });
        }
    ...
    public boolean register() {
        ...
        if (cls == null) {
            f.e().d(str, "Firebase Analytics is not present; you will not see automatic logging of events before a crash occurs.");
            return false;
        }
        Object instance = getInstance(cls);
        if (instance == null) {
            f.e().a(str, "Cannot register AppMeasurement Listener for Crashlytics breadcrumbs: Could not create an instance of Firebase Analytics.");
            return false;
        }
        Class cls2 = getClass(ANALYTIC_CLASS_ON_EVENT_LISTENER);
        if (cls2 == null) {
            f.e().a(str, "Cannot register AppMeasurement Listener for Crashlytics breadcrumbs: Could not get class com.google.android.gms.measurement.AppMeasurement$OnEventListener");
            return false;
        }
        try {
            cls.getDeclaredMethod(REGISTER_METHOD, new Class[]{cls2}).invoke(instance, new Object[]{getOnEventListenerProxy(cls2)});
        } catch (NoSuchMethodException e2) {
            f.e().a(str, "Cannot register AppMeasurement Listener for Crashlytics breadcrumbs: Method registerOnMeasurementEventListener not found.", (Throwable) e2);
            return false;
        } catch (Exception e3) {
            o e4 = f.e();
            StringBuilder sb = new StringBuilder();
            ...
            e4.a(str, sb.toString(), (Throwable) e3);
        }
        return true;
    }
}
