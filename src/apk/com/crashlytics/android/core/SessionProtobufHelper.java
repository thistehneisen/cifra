...
class SessionProtobufHelper {
    ...
    private static int getEventAppExecutionExceptionSize(TrimmedThrowableData trimmedThrowableData, int i2, int i3) {
        int i4 = 0;
    ...
    private static int getEventAppExecutionSize(TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i2, ByteString byteString, ByteString byteString2) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            int threadSize2 = getThreadSize(threadArr[i4], (StackTraceElement[]) list.get(i4), 0, false);
            i3 += CodedOutputStream.computeTagSize(1) + CodedOutputStream.computeRawVarint32Size(threadSize2) + threadSize2;
        }
        int eventAppExecutionExceptionSize = getEventAppExecutionExceptionSize(trimmedThrowableData, 1, i2);
        int computeTagSize2 = i3 + CodedOutputStream.computeTagSize(2) + CodedOutputStream.computeRawVarint32Size(eventAppExecutionExceptionSize) + eventAppExecutionExceptionSize;
    ...
    private static int getEventAppSize(TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i2, ByteString byteString, ByteString byteString2, Map<String, String> map, RunningAppProcessInfo runningAppProcessInfo, int i3) {
    ...
    private static int getEventDeviceSize(Float f2, int i2, boolean z, int i3, long j2, long j3) {
        int i4 = 0;
        if (f2 != null) {
    ...
    private static int getFrameSize(StackTraceElement stackTraceElement, boolean z) {
        ...
        int computeBytesSize = i4 + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(sb.toString()));
    ...
    private static int getSessionAppSize(ByteString byteString, ByteString byteString2, ByteString byteString3, ByteString byteString4, ByteString byteString5, int i2, ByteString byteString6) {
        ...
        return computeTagSize + CodedOutputStream.computeEnumSize(10, i2);
    }

    private static int getSessionDeviceSize(int i2, ByteString byteString, int i3, long j2, long j3, boolean z, Map<a, String> map, int i4, ByteString byteString2, ByteString byteString3) {
        int i5;
        int i6;
        int i7 = 0;
        ...
        if (map != null) {
            for (Entry entry : map.entrySet()) {
                int deviceIdentifierSize = getDeviceIdentifierSize((a) entry.getKey(), (String) entry.getValue());
    ...
    private static int getSessionEventSize(long j2, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i2, Map<String, String> map, RunningAppProcessInfo runningAppProcessInfo, int i3, ByteString byteString, ByteString byteString2, Float f2, int i4, boolean z, long j3, long j4, ByteString byteString3) {
        long j5 = j2;
    ...
    private static int getThreadSize(Thread thread, StackTraceElement[] stackTraceElementArr, int i2, boolean z) {
    ...
    private static void writeFrame(CodedOutputStream codedOutputStream, int i2, StackTraceElement stackTraceElement, boolean z) throws Exception {
    ...
    public static void writeSessionApp(CodedOutputStream codedOutputStream, String str, String str2, String str3, String str4, String str5, int i2, String str6) throws Exception {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i2, String str, int i3, long j2, long j3, boolean z, Map<a, String> map, int i4, String str2, String str3) throws Exception {
        ...
        for (Entry entry : map.entrySet()) {
            ...
            codedOutputStream2.writeRawVarint32(getDeviceIdentifierSize((a) entry.getKey(), (String) entry.getValue()));
            codedOutputStream2.writeEnum(1, ((a) entry.getKey()).protobufIndex);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j2, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, RunningAppProcessInfo runningAppProcessInfo, int i2, String str2, String str3, Float f2, int i3, boolean z, long j3, long j4) throws Exception {
    ...
    private static void writeSessionEventApp(CodedOutputStream codedOutputStream, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i2, ByteString byteString, ByteString byteString2, Map<String, String> map, RunningAppProcessInfo runningAppProcessInfo, int i3) throws Exception {
    ...
    private static void writeSessionEventAppExecution(CodedOutputStream codedOutputStream, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i2, ByteString byteString, ByteString byteString2) throws Exception {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            writeThread(codedOutputStream, threadArr[i3], (StackTraceElement[]) list.get(i3), 0, false);
        }
    ...
    private static void writeSessionEventAppExecutionException(CodedOutputStream codedOutputStream, TrimmedThrowableData trimmedThrowableData, int i2, int i3, int i4) throws Exception {
    ...
    private static void writeSessionEventDevice(CodedOutputStream codedOutputStream, Float f2, int i2, boolean z, int i3, long j2, long j3) throws Exception {
        codedOutputStream.writeTag(5, 2);
    ...
    private static void writeThread(CodedOutputStream codedOutputStream, Thread thread, StackTraceElement[] stackTraceElementArr, int i2, boolean z) throws Exception {
        codedOutputStream.writeTag(1, 2);
