...
final class k extends i implements a<m> {
    ...
    k(MoreViewController moreViewController) {
        this.this$0 = moreViewController;
        super(0);
    }

    public final void b() {
        ((c) this.this$0.getActivity()).d().a(h.FACEBOOK);
        b.b(this.this$0.getActivity(), this.this$0.getString(R.string.common_global_url_social_fb));
    }
}
