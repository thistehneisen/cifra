...
final class j extends i implements a<m> {
    ...
    j(MoreViewController moreViewController) {
        this.this$0 = moreViewController;
        super(0);
    }

    public final void b() {
        d.a(((c) this.this$0.getActivity()).c(), LoginSettingsViewController.class, b.f11113a, false, LoginSettingsViewController.class.getName(), null, 20, null);
    }
}
