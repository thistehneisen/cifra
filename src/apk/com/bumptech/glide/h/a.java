...
public final class a {
    ...
    private static final AtomicReference<byte[]> f3503a = new AtomicReference<>();

    /* renamed from: com.bumptech.glide.h.a$a reason: collision with other inner class name */
    /* compiled from: ByteBufferUtil */
    private static class C0048a extends InputStream {

        /* renamed from: a reason: collision with root package name */
        private final ByteBuffer f3504a;

        /* renamed from: b reason: collision with root package name */
        private int f3505b = -1;

        C0048a(ByteBuffer byteBuffer) {
            this.f3504a = byteBuffer;
        }

        public int available() {
            return this.f3504a.remaining();
        }

        public synchronized void mark(int i2) {
            this.f3505b = this.f3504a.position();
        }
        ...
        public synchronized void reset() throws IOException {
            if (this.f3505b != -1) {
                this.f3504a.position(this.f3505b);
            } else {
        ...
        public long skip(long j2) throws IOException {
            ...
            ByteBuffer byteBuffer = this.f3504a;
    ...
    public static byte[] a(ByteBuffer byteBuffer) {
        b c2 = c(byteBuffer);
        if (c2 != null && c2.f3506a == 0 && c2.f3507b == c2.f3508c.length) {
