...
public final class i implements ImageHeaderParser {
    ...
    static final byte[] f3728a = "Exif\u0000\u0000".getBytes(Charset.forName("UTF-8"));

    /* renamed from: b reason: collision with root package name */
    private static final int[] f3729b = {0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};

    /* compiled from: DefaultImageHeaderParser */
    private static final class a implements c {

        /* renamed from: a reason: collision with root package name */
        private final ByteBuffer f3730a;

        a(ByteBuffer byteBuffer) {
            this.f3730a = byteBuffer;
        ...
        public long skip(long j2) {
            int min = (int) Math.min((long) this.f3730a.remaining(), j2);
            ByteBuffer byteBuffer = this.f3730a;
            byteBuffer.position(byteBuffer.position() + min);
            return (long) min;
        }

        public int a(byte[] bArr, int i2) {
            int min = Math.min(i2, this.f3730a.remaining());
            if (min == 0) {
                return -1;
            }
            this.f3730a.get(bArr, 0, min);
            return min;
        }
    }
    ...
    private static final class b {
        ...
        /* renamed from: a reason: collision with root package name */
        private final ByteBuffer f3731a;

        b(byte[] bArr, int i2) {
            this.f3731a = (ByteBuffer) ByteBuffer.wrap(bArr).order(ByteOrder.BIG_ENDIAN).limit(i2);
        }

        /* access modifiers changed from: 0000 */
        public void a(ByteOrder byteOrder) {
            this.f3731a.order(byteOrder);
        }

        /* access modifiers changed from: 0000 */
        public int b(int i2) {
            if (a(i2, 4)) {
                return this.f3731a.getInt(i2);
            }
            return -1;
        }
        ...
        /* access modifiers changed from: 0000 */
        public int a() {
            return this.f3731a.remaining();
        }

        /* access modifiers changed from: 0000 */
        public short a(int i2) {
            if (a(i2, 2)) {
                return this.f3731a.getShort(i2);
            }
            return -1;
        }

        private boolean a(int i2, int i3) {
            return this.f3731a.remaining() - i2 >= i3;
        }
    }
    ...
    private static final class d implements c {
        ...
        public int a() throws IOException {
            return ((this.f3732a.read() << 8) & 65280) | (this.f3732a.read() & 255);
        }

        public short b() throws IOException {
            return (short) (this.f3732a.read() & 255);
        }

        public int c() throws IOException {
            return this.f3732a.read();
        }
        ...
        public long skip(long j2) throws IOException {
            ...
            long j3 = j2;
            while (j3 > 0) {
                long skip = this.f3732a.skip(j3);
                if (skip <= 0) {
                    if (this.f3732a.read() == -1) {
                        break;
                    }
                    skip = 1;
                }
        ...
        public int a(byte[] bArr, int i2) throws IOException {
            int i3 = i2;
            while (i3 > 0) {
                int read = this.f3732a.read(bArr, i2 - i3, i3);
                if (read == -1) {
                    break;
                }
                i3 -= read;
    ...
    private boolean a(byte[] bArr, int i2) {
        boolean z = bArr != null && i2 > f3728a.length;
        if (!z) {
            return z;
        }
        int i3 = 0;
