...
import io.intercom.com.bumptech.glide.load.b.r;
...
public final class j {
    ...
    private static final char[] f9406a = "0123456789abcdef".toCharArray();

    /* renamed from: b reason: collision with root package name */
    private static final char[] f9407b = new char[64];
    ...
    private static int a(Config config) {
        ...
        int i2 = i.f9405a[config.ordinal()];
        if (i2 != 1) {
