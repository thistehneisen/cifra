...
abstract class ParameterHandler<T> {
    ...
    static final class RawPart extends ParameterHandler<io.intercom.okhttp3.MultipartBody.Part> {
        ...
        /* access modifiers changed from: 0000 */
        public void apply(RequestBuilder requestBuilder, io.intercom.okhttp3.MultipartBody.Part part) throws IOException {
            if (part != null) {
