        ...
        if (i2 < 1 || i2 > 65535) {
            ...
            if (!lookup.isEmpty()) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    this.inetSocketAddresses.add(new InetSocketAddress((InetAddress) lookup.get(i3), i2));
                }
                return;
            }
        ...
        if (hasNext()) {
            ...
            while (hasNextProxy()) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    Route route = new Route(this.address, nextProxy, (InetSocketAddress) this.inetSocketAddresses.get(i2));
