...
class l implements x {
    ...
    private g c(JSONObject jSONObject) throws JSONException {
        return new g(jSONObject.optString("update_endpoint", w.f8980a), jSONObject.optInt("update_suspend_duration", 3600));
    }
    ...
    private p f(JSONObject jSONObject) throws JSONException {
        p pVar = new p(jSONObject.optString("title", "Send Crash Report?"), jSONObject.optString(Object.MESSAGE, "Looks like we crashed! Please help us fix the problem by sending a crash report."), jSONObject.optString("send_button_title", "Send"), jSONObject.optBoolean("show_cancel_button", true), jSONObject.optString("cancel_button_title", "Don't Send"), jSONObject.optBoolean("show_always_send_button", true), jSONObject.optString("always_send_button_title", "Always Send"));
        return pVar;
    }
    ...
    public v a(n nVar, JSONObject jSONObject) throws JSONException {
        int optInt = jSONObject.optInt("settings_version", 0);
        int optInt2 = jSONObject.optInt("cache_duration", 3600);
        v vVar = new v(a(nVar, (long) optInt2, jSONObject), b(jSONObject.getJSONObject("app")), g(jSONObject.getJSONObject("session")), f(jSONObject.getJSONObject("prompt")), d(jSONObject.getJSONObject("features")), a(jSONObject.getJSONObject("analytics")), c(jSONObject.getJSONObject(BuildConfig.ARTIFACT_ID)), optInt, optInt2);
        return vVar;
    }
    ...
    private long a(n nVar, long j2, JSONObject jSONObject) throws JSONException {
        String str = "expires_at";
        if (jSONObject.has(str)) {
            return jSONObject.getLong(str);
        }
        return nVar.a() + (j2 * 1000);
    }
}
